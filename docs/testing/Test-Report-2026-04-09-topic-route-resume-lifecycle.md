...
- Command: `pnpm test:headed-topic-route-resume-lifecycle -- --report docs/testing/Test-Report-2026-04-09-topic-route-resume-lifecycle.md`
- Artifacts Dir: `/tmp/openshock-topic-route-pyCWf2`
...
## Screenshots
- run-detail: /tmp/openshock-topic-route-pyCWf2/screenshots/01-run-detail.png
- topic-route: /tmp/openshock-topic-route-pyCWf2/screenshots/02-topic-route.png
- topic-guidance: /tmp/openshock-topic-route-pyCWf2/screenshots/03-topic-guidance.png
- topic-paused: /tmp/openshock-topic-route-pyCWf2/screenshots/04-topic-paused.png
- topic-reload-paused: /tmp/openshock-topic-route-pyCWf2/screenshots/05-topic-reload-paused.png
- topic-resumed: /tmp/openshock-topic-route-pyCWf2/screenshots/06-topic-resumed.png
- room-topic-backlink: /tmp/openshock-topic-route-pyCWf2/screenshots/07-room-topic-backlink.png
