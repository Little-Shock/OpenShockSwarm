...
- Command: `pnpm test:headed-quick-search -- --report docs/testing/Test-Report-2026-04-09-quick-search-message-surface-contract.md`
- Artifacts Dir: `/tmp/openshock-tkt27-quick-search-artifacts`
...
- channel-roadmap: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/01-channel-roadmap.png
- room-runtime: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/02-room-runtime.png
- issue-ops-19: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/03-issue-ops-19.png
- run-runtime-01: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/04-run-runtime-01.png
- agent-dockmaster: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/05-agent-dockmaster.png
- dm-mina: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/06-dm-mina.png
- followed-thread-result: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/07-followed-thread-result.png
- saved-thread-result: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/08-saved-thread-result.png
- no-matches: /tmp/openshock-tkt27-quick-search-artifacts/run/screenshots/09-no-matches.png
