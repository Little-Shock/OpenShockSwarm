...
- Command: `pnpm test:headed-destructive-guard -- --report docs/testing/Test-Report-2026-04-08-destructive-guard.md`
- Artifacts Dir: `/tmp/openshock-tkt30-artifacts`
...
## Screenshots
- inbox-guard-intake: /tmp/openshock-tkt30-artifacts/screenshots/01-inbox-guard-intake.png
- room-runtime-guard: /tmp/openshock-tkt30-artifacts/screenshots/02-room-runtime-guard.png
- run-runtime-guard: /tmp/openshock-tkt30-artifacts/screenshots/03-run-runtime-guard.png
- runtime-deferred: /tmp/openshock-tkt30-artifacts/screenshots/04-runtime-deferred.png
- room-memory-guard-blocked: /tmp/openshock-tkt30-artifacts/screenshots/05-room-memory-guard-blocked.png
- memory-resolved: /tmp/openshock-tkt30-artifacts/screenshots/06-memory-resolved.png
