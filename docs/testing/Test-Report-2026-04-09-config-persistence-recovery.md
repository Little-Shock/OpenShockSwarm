...
- Command: `pnpm test:headed-config-persistence-recovery -- --report docs/testing/Test-Report-2026-04-09-config-persistence-recovery.md`
- Generated At: 2026-04-08T16:40:04.155Z
...
- settings-before-write: `../openshock-tkt37-artifacts/run/screenshots/01-settings-before-write.png`
- settings-after-write: `../openshock-tkt37-artifacts/run/screenshots/02-settings-after-write.png`
- access-projection: `../openshock-tkt37-artifacts/run/screenshots/03-access-projection.png`
- setup-projection: `../openshock-tkt37-artifacts/run/screenshots/04-setup-projection.png`
- settings-after-server-restart: `../openshock-tkt37-artifacts/run/screenshots/05-settings-after-server-restart.png`
- second-device-recovery: `../openshock-tkt37-artifacts/run/screenshots/06-second-device-recovery.png`
