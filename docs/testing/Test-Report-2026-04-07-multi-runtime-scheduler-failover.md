...
- Harness: `pnpm test:headed-multi-runtime-scheduler-failover -- --report docs/testing/Test-Report-2026-04-07-multi-runtime-scheduler-failover.md`
- Scope: `TKT-14 / CHK-14 / TC-020`
- Result: `PASS`

## Environment

- server URL: `http://127.0.0.1:43906`
- web URL: `http://127.0.0.1:44786`
- runtimes:
...
- run-sidecar-preference: `/tmp/openshock-tkt14-runtime-scheduler-VbisHK/screenshots/01-run-sidecar-preference.png`
- setup-failover-preview: `/tmp/openshock-tkt14-runtime-scheduler-VbisHK/screenshots/02-setup-failover-preview.png`
- run-failover-detail: `/tmp/openshock-tkt14-runtime-scheduler-VbisHK/screenshots/03-run-failover-detail.png`
