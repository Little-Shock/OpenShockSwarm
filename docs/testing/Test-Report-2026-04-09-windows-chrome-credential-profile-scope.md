...
- Command: `pnpm test:headed-credential-profile-scope -- --report docs/testing/Test-Report-2026-04-09-windows-chrome-credential-profile-scope.md`
- Artifacts Dir: `/tmp/openshock-tkt45-credential-scope-Iroybm`
...
- settings-credential-created: /tmp/openshock-tkt45-credential-scope-Iroybm/run/screenshots/01-settings-credential-created.png
- profile-agent-credential-bound: /tmp/openshock-tkt45-credential-scope-Iroybm/run/screenshots/02-profile-agent-credential-bound.png
- run-credential-scope-bound: /tmp/openshock-tkt45-credential-scope-Iroybm/run/screenshots/03-run-credential-scope-bound.png
- profile-credential-run-count: /tmp/openshock-tkt45-credential-scope-Iroybm/run/screenshots/04-profile-credential-run-count.png
- settings-credential-usage-audit: /tmp/openshock-tkt45-credential-scope-Iroybm/run/screenshots/05-settings-credential-usage-audit.png
