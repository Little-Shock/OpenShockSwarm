...
- Command: `pnpm test:headed-notification-preference-delivery -- --report docs/testing/Test-Report-2026-04-07-notification-preference-delivery.md`
- Artifacts Dir: `/tmp/openshock-tkt11-notification-fHRDBo`
...
- initial-notification-settings: /tmp/openshock-tkt11-notification-fHRDBo/run/screenshots/01-initial-notification-settings.png
- invalid-email-fanout-failure: /tmp/openshock-tkt11-notification-fHRDBo/run/screenshots/02-invalid-email-fanout-failure.png
- retry-fanout-green: /tmp/openshock-tkt11-notification-fHRDBo/run/screenshots/03-retry-fanout-green.png
