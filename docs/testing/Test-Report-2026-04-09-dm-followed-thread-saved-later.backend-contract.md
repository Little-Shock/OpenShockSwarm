...
- Command: `pnpm test:headed-dm-followed-thread-saved-later -- --report docs/testing/Test-Report-2026-04-09-dm-followed-thread-saved-later.backend-contract.md`
- Artifacts Dir: `/tmp/openshock-tkt27-artifacts`
...
## Screenshots
- dm-surface: /tmp/openshock-tkt27-artifacts/screenshots/01-dm-surface.png
- channel-thread-actions: /tmp/openshock-tkt27-artifacts/screenshots/02-channel-thread-actions.png
- followed-panel: /tmp/openshock-tkt27-artifacts/screenshots/03-followed-panel.png
- followed-reopen: /tmp/openshock-tkt27-artifacts/screenshots/04-followed-reopen.png
- saved-panel: /tmp/openshock-tkt27-artifacts/screenshots/05-saved-panel.png
- saved-reopen: /tmp/openshock-tkt27-artifacts/screenshots/06-saved-reopen.png
