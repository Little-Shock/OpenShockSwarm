...
- Command: `pnpm test:headed-memory-viewer-correction-forget -- --report docs/testing/Test-Report-2026-04-09-windows-chrome-memory-viewer-correction-forget.md`
- Artifacts Dir: `/tmp/openshock-tkt42-memory-viewer-XkjPrk`
...
- initial-memory-viewer: /tmp/openshock-tkt42-memory-viewer-XkjPrk/run/screenshots/01-initial-memory-viewer.png
- memory-correction-written: /tmp/openshock-tkt42-memory-viewer-XkjPrk/run/screenshots/02-memory-correction-written.png
- memory-forgotten: /tmp/openshock-tkt42-memory-viewer-XkjPrk/run/screenshots/03-memory-forgotten.png
