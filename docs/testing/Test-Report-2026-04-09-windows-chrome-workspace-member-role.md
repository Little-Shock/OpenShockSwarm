...
- Command: `pnpm test:headed-workspace-member-role -- --report docs/testing/Test-Report-2026-04-09-windows-chrome-workspace-member-role.md`
- Artifacts Dir: `/tmp/openshock-tkt08-workspace-member-role-8KXhfA`
...
- invited-viewer: /tmp/openshock-tkt08-workspace-member-role-8KXhfA/run/screenshots/01-invited-viewer.png
- invited-member: /tmp/openshock-tkt08-workspace-member-role-8KXhfA/run/screenshots/02-invited-member.png
- member-activated: /tmp/openshock-tkt08-workspace-member-role-8KXhfA/run/screenshots/03-member-activated.png
- member-suspended: /tmp/openshock-tkt08-workspace-member-role-8KXhfA/run/screenshots/04-member-suspended.png
- suspended-login-blocked: /tmp/openshock-tkt08-workspace-member-role-8KXhfA/run/screenshots/05-suspended-login-blocked.png
