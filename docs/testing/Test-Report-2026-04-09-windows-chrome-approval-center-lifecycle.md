...
- Command: `pnpm test:headed-approval-center-lifecycle -- --report docs/testing/Test-Report-2026-04-09-windows-chrome-approval-center-lifecycle.md`
- Artifacts Dir: `/tmp/openshock-tkt10-approval-center-OuDR4K`
...
- review-signal-backlinks: /tmp/openshock-tkt10-approval-center-OuDR4K/run/screenshots/01-review-signal-backlinks.png
- approval-approved: /tmp/openshock-tkt10-approval-center-OuDR4K/run/screenshots/02-approval-approved.png
- blocked-resolved: /tmp/openshock-tkt10-approval-center-OuDR4K/run/screenshots/03-blocked-resolved.png
- review-synced-merged: /tmp/openshock-tkt10-approval-center-OuDR4K/run/screenshots/04-review-synced-merged.png
