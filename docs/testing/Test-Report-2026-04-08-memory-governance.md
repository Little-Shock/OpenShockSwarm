...
- Command: `pnpm test:headed-memory-governance -- --report docs/testing/Test-Report-2026-04-08-memory-governance.md`
- Artifacts Dir: `/tmp/openshock-tkt12-memory-governance-RwaGER`
...
- initial-memory-center: /tmp/openshock-tkt12-memory-governance-RwaGER/run/screenshots/01-initial-memory-center.png
- policy-preview-updated: /tmp/openshock-tkt12-memory-governance-RwaGER/run/screenshots/02-policy-preview-updated.png
- skill-promotion-approved: /tmp/openshock-tkt12-memory-governance-RwaGER/run/screenshots/03-skill-promotion-approved.png
- policy-ledger-approved: /tmp/openshock-tkt12-memory-governance-RwaGER/run/screenshots/04-policy-ledger-approved.png
